...
namespace AddWaterMark.Utils {
    public class GifEncoder : IDisposable {
        ...
        public GifEncoder(string filePath, int? width = null, int? height = null, int? repeatCount = null) {
        ...
        /// <param name="frameDelay">延迟时间（毫秒）</param>
        public void AddFrame(Image img, int x = 0, int y = 0, int frameDelay = 0) {
        ...
        private void WriteGraphicControlBlock(Stream sourceGif, int delay) {
            ...
            WriteShort(delay); // Setting frame delay
